...
queueConfig.n4Queue = true

queueConfig.Message = 'is roaming Chicago IL.'
queueConfig.Streetnames = true
queueConfig.CharacterNames = true
...
queueConfig.Discord = {
    ...
    ApplicationID = '1436825339920646244',
    Asset = 'lcrp1',

    SetDiscordRichPresenceAssetText = 'Lake City Roleplay V2',
    SetDiscordRichPresenceAssetSmall = 'lcrp1',
    SetDiscordRichPresenceAssetSmallText = '',

    -- These are the buttons that show in discord under the persons name
    SetDiscordRichPresenceAction = 'Discord',
    SetDiscordRichPresenceActionText = 'https://discord.gg/lakecity',
    SetDiscordRichPresenceAction2 = 'Store',
    SetDiscordRichPresenceActionText2 = 'https://lakecity.tebex.io/',
    --
